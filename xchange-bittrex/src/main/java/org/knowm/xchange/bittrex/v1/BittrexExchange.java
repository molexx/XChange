...
public class BittrexExchange extends BaseExchange implements Exchange {
  ...
  public void remoteInit() throws IOException, ExchangeException {
    List<BittrexSymbol> bittrexSymbols = ((BittrexMarketDataServiceRaw) pollingMarketDataService).getBittrexSymbols();  //calls public/getmarkets

    exchangeMetaData = BittrexAdapters.adaptToExchangeMetaData(bittrexSymbols);
  }
}